...
namespace DeepZoom
{
    ...
    public abstract class MultiScaleTileSource : DependencyObject
    {
        ...
        public double AbsoluteWidth { get; protected set; }
        public double AbsoluteHeight { get; protected set; }
        ...
        public Size ImageSizeAtLevel(int level)
        {
        ...
        public int TilesAtLevel(int level)
        {
            checked
            {
        ...
        public IEnumerable<Tile> VisibleTiles(Rect rectangle, int level)
        {
