...
namespace DeepZoom
{
    ...
    public class DeepZoomImageTileSource : MultiScaleTileSource
    {
        ...
        public double AbsoluteWidth { get; private set; }

        public double AbsoluteHeight { get; private set; }
        ...
        private void LoadDeepZoomXml()
        {
            ...
            AbsoluteHeight = (double)sizeElement.Attribute("Height");
            AbsoluteWidth = (double)sizeElement.Attribute("Width");
